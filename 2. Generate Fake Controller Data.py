...
while (num_files_to_generate < 0 or file_num < num_files_to_generate):
    ...
    seconds_to_sleep = random.gauss(average_millis_between_file_generation, average_millis_between_file_generation/5) / 1000.0
    ...
    num_lines = average_num_lines_per_file+1+round( (random.uniform(0, 1)-0.5)*0.1*average_num_lines_per_file )
